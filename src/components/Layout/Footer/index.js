                            ...
                            <div className="col-xs-12 col-md-4 col-lg Footer-col">
                                ...
                                <ul className="Footer-links">
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Servicios</Link>
                                    </li>
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Productos</Link>
                                    </li>
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Bodas</Link>
                                    </li>
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Estilos</Link>
                                    </li>
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Locales Bellify</Link>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-xs-12 col-md-4 col-lg Footer-col">
                                ...
                                <ul className="Footer-links">
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Nuestro Equipo</Link>
                                    </li>
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Partners</Link>
                                    </li>
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Blog</Link>
                                    </li>
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Reviews</Link>
                                    </li>
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Prensa y medios</Link>
                                    </li>
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Únete a nosotros</Link>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-xs-12 col-md-4 col-lg Footer-col">
                                ...
                                <ul className="Footer-links">
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">FAQ</Link>
                                    </li>
                                    <li className="Footer-link">
                                    ...
                                    <li className="Footer-link">
                                        <Link to="#" className="text-small">Contacto</Link>
                                    </li>
                                </ul>
                            </div>
